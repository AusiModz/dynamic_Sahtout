...
<head>
    ...
    <style>
        ...
        body.home {
            background: url('<?php echo SUBDIR ?>img/backgrounds/bg-home.jpg') no-repeat center center fixed;
...
<body class="home">
    <main>
        ...
        <section class="intro-container">
            ...
            <div class="intro-buttons">
                <a href="<?php echo SUBDIR ?>register" class="intro-button"><?php echo translate('home_create_account', 'Create Account'); ?></a>
                <a href="<?php echo SUBDIR ?>download" class="intro-button"><?php echo translate('home_download', 'Download'); ?></a>
            </div>
            <div class="social-container">
                <hr class="social-line">
                <a href="<?php echo $social_links['youtube']; ?>" class="youtube-button" aria-label="<?php echo translate('youtube_alt', 'YouTube'); ?>">
                    <img src="<?php echo SUBDIR ?>img/homeimg/youtube-logo1.png" alt="<?php echo translate('youtube_alt', 'YouTube'); ?>" class="youtube-logo">
                </a>
                <hr class="social-line">
                <a href="<?php echo $social_links['discord']; ?>" class="discord-button" aria-label="<?php echo translate('discord_alt', 'Discord'); ?>">
                    <img src="<?php echo SUBDIR ?>img/homeimg/discordlogo.png" alt="<?php echo translate('discord_alt', 'Discord'); ?>" class="discord-logo">
                </a>
                <hr class="social-line">
                <a href="<?php echo $social_links['instagram']; ?>" class="instagram-button" aria-label="<?php echo translate('instagram_alt', 'Instagram'); ?>">
                    <img src="<?php echo SUBDIR ?>img/homeimg/insta-logo.png" alt="<?php echo translate('instagram_alt', 'Instagram'); ?>" class="instagram-logo">
                </a>
                <hr class="social-line">
            </div>
        </section>
        ...
        <section class="hero-gallery">
            <div class="slider" id="slider">
                <div class="slide"><img src="<?php echo SUBDIR ?>img/homeimg/slide1.jpg" alt="<?php echo translate('slider_alt_1', 'World of Warcraft Scene 1'); ?>"></div>
                <div class="slide"><img src="<?php echo SUBDIR ?>img/homeimg/slide2.jpg" alt="<?php echo translate('slider_alt_2', 'World of Warcraft Scene 2'); ?>"></div>
                <div class="slide"><img src="<?php echo SUBDIR ?>img/homeimg/slide3.jpg" alt="<?php echo translate('slider_alt_3', 'World of Warcraft Scene 3'); ?>"></div>
            </div>
    ...
    ?>
    <script src="<?php echo SUBDIR ?>assets/js/home.js"></script>
</body>
</html>